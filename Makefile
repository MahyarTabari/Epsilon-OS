...
./build/io/disk/disk.o:	./src/io/disk/disk.c
	i686-elf-gcc $(INCLUDES) -I./src/io/disk $(FLAGS) -std=gnu99 -c ./src/io/disk/disk.c -o ./build/io/disk/disk.o
